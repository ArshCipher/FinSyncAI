...
const ChatWindow: React.FC<ChatWindowProps> = ({ 
  ...
  return (
    <div className="flex items-center justify-center h-full px-12 lg:px-20 animate-fade-in-up">
      {/* Chat card with glassmorphism */}
      <div className="glass rounded-3xl w-full max-w-2xl h-[85vh] flex flex-col shadow-2xl overflow-hidden">
